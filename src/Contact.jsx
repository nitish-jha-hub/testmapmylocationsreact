    ...
    <div className="container-fluid pt-5">
      <div className="row align-items-center mb-5">
        <div className="col-md-6 mb-4 mb-md-0">
          <img src="https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=600&q=80" alt="Contact VyqdaTech" className="img-fluid rounded shadow" />
        </div>
      ...
      <form className="mx-auto mb-5" style={{ maxWidth: 600 }}>
